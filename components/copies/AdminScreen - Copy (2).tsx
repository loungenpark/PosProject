...
import { EditIcon, TrashIcon, PlusIcon, CloseIcon, ChartBarIcon, MenuIcon, TableIcon, PercentIcon, UserGroupIcon, BoxIcon, PrinterIcon } from './common/Icons'; // --- MODIFIED: Added PrinterIcon ---
...
// --- NEW: DeviceSettings Component ---
const DeviceSettings: React.FC = () => {
    // We check localStorage directly to see if this device is the print station.
    const [isPrintStation, setIsPrintStation] = useState(localStorage.getItem('isPrintStation') === 'true');

    const handleSetPrintStation = () => {
        // Set the flag in localStorage for this device.
    ...
    const handleUnsetPrintStation = () => {
        // Remove the flag from this device.
...
type AdminTab = 'sales' | 'menu' | 'stock' | 'users' | 'tax' | 'tables' | 'device'; // --- MODIFIED: Added 'device' tab ---
    ...
    <div className="fixed inset-0 bg-primary z-50 flex flex-col">
      ...
      <div className="flex flex-grow overflow-hidden">
        <nav className="w-64 bg-secondary p-4 space-y-2">
            ...
            {/* --- NEW: Button for Device Settings Tab --- */}
        ...
        <main className="flex-grow p-6 overflow-y-auto">
            ...
            {/* --- NEW: Render the DeviceSettings component --- */}

...
export const PosProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // --- MODIFIED: This function is now case-sensitive and more robust ---
        ...
        Papa.parse(file, {
            ...
            complete: async (results) => {
                ...
                for (const row of results.data as any[]) {
                    ...
                    // --- FIX: Correctly read the Printer value ---
                    ...
                    const newItem: Omit<MenuItem, 'id'> = {
                        ...
                        category: category,
                        // --- FIX: Use the corrected printer value ---
                        printer: (printerValue === 'SHANK' ? Printer.BAR : Printer.KITCHEN),
                        // --- END FIX ---
                        trackStock: false,
                        stock: Infinity,
                        stockThreshold: 0,

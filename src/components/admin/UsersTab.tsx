            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        >
                            <span
                                className={`inline-block w-4 h-4 transform bg-white rounded-full transition-transform ${autoLogoutEnabled ? 'translate-x-6' : 'translate-x-1'
                                    }`}
                            />
                        </button>
                    </div>
                    ...
                    {/* Add User Button */}
                    <button onClick={() => setIsModalOpen(true)} className="flex items-center space-x-2 px-4 py-2 bg-highlight text-white rounded-md hover:bg-highlight-hover">
                            ...
                            <tr key={user.id}>
                                ...
                                <td className="p-3">
                                    <button
                                        ...
                                        className="p-2 text-danger hover:text-danger-hover"
                                    >

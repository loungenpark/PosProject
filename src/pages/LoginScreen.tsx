...
const LoginScreen: React.FC = () => {
  ...
  const buttonClasses = "p-4 text-2xl font-bold text-text-main bg-accent rounded-lg hover:bg-highlight focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-150 ease-in-out active:bg-blue-600 active:scale-95";
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary">
      <div className="w-full max-w-xs p-8 space-y-6 bg-secondary rounded-xl shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="text-red-400 text-center text-sm h-5">{error}</div>
